...
with st.sidebar:
    ...
    st.write("② : 会計の合計を11％オフにした場合")
    st.write(str(int(total2 * 0.89)) + "円　(" + str(int(total2 - total2 * 0.89)) + "円得)")
    st.write("③ : ①と飲みpassと併用した場合")
    st.write(str(550 + total3) + "円　(" + str(total2 - (550 +total3)) + "円得)")
    st.write("④ : ②と飲みpassと併用した場合")
    st.write(str(int(550 + total4 * 0.89)) + "円　(" + str(int(total2 - (550 + total4 * 0.89))) + "円得)")
